...
<%--MAIN form register--%>
<form class="container mt-5" style="height: 700px;" action="register" method="post" action="<%=request.getContextPath()%>/register">
    ...
    <div class="form-group">
        ...
        <input type="password" name="retypedPassword" class="form-control" id="exampleInputPassword" placeholder="Password">
    </div>
